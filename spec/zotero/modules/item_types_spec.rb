...
RSpec.describe Zotero::ItemTypes do
  ...
  describe "#item_types" do
    it "returns item types without locale" do
      ...
      expect(instance).to receive(:get).with("/itemTypes", params: {}).and_return(item_types_response)
    ...
    it "returns item types with locale" do
      ...
      expect(instance).to receive(:get).with("/itemTypes", params: { locale: "fr-FR" }).and_return(item_types_response)
  ...
  describe "#item_type_fields" do
    it "returns fields for item type" do
      ...
      expect(instance).to receive(:get).with("/itemTypeFields",
  ...
  describe "#item_type_creator_types" do
    it "returns creator types for item type" do
      ...
      expect(instance).to receive(:get).with("/itemTypeCreatorTypes",
                                             params: { itemType: "book" }).and_return(creator_types_response)
  ...
  describe "#new_item_template" do
    it "returns new item template" do
      ...
      expect(instance).to receive(:get).with("/items/new",
